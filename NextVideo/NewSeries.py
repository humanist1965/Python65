...
def main():
    ...
    ns.createYAMLfromTVHOMEUrl("MMM",1,"TVHOME_RAW/MMM1.html")
    ns.createYAMLfromTVHOMEUrl("MMM",2,"TVHOME_RAW/MMM2.html")
    ns.createYAMLfromTVHOMEUrl("MMM",3,"TVHOME_RAW/MMM3.html")
